...
/*
    class huffman2.ấ.java.Node{
        int val;
        ArrayList<huffman2.ấ.java.Node> neighbors;
        public huffman2.ấ.java.Node(){
            val = 0;
            neighbors = new ArrayList<>();
        }

        public huffman2.ấ.java.Node(int val){
            this.val = val;
            neighbors = new ArrayList<>();
        }

        public huffman2.ấ.java.Node(int val, ArrayList<huffman2.ấ.java.Node> neighbors){
            this.val = val;
            this.neighbors = neighbors;
        }
    }
...
class Solution{
    Node cloneGraph(Node node){
        ...
        while (!q.isEmpty())
        {
            ...
            // Get corresponding Cloned Graph huffman2.ấ.java.Node
            ...
            if (u.neighbors != null)
            {
                ...
                for (Node graphNode : v)
                {
                    ...
                    if (cloneNodeG == null)
                    {
                        ...
                        // If not then create a new huffman2.ấ.java.Node and
        ...
        // Return the reference of cloned source huffman2.ấ.java.Node
        return hm.get(node);
    }
}
