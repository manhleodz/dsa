package g.dsa.hw7_21000691_doanducmanh.ex3;

import g.dsa.hw7_21000691_doanducmanh.ex2.BinaryTreeInterface;
...
public class LinkedBinaryTree<E extends Comparable<E>, T> implements BinaryTreeInterface<T> {
    ...
    public static class Node<E extends Comparable<E>> {
        public int height; // Chiều cao của cây được tính từ nút lá lên
        public E element; // an element stored at this node
        public Node<E> parent; // matrix reference to the parent node (if any)
        public Node<E> left; // matrix reference to the left child
        public Node<E> right; // matrix reference to the right child
