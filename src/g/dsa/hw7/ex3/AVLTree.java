...
//    public huffman2.ấ.java.Node<E> search(E x) {return super.search(x, this.root);}
    ...
    public void preOrder(Node<E> node) {
        if (node != null) {
            preOrder(node.left);
            System.out.println("huffman2.ấ.java.Node: " + node.element + " -Height: " + getHeight(node));
            preOrder(node.right);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Include 100:" + tree.search(100));
