...
public class BinarySearchTree<E extends Comparable<E>, T> extends LinkedBinaryTree<E, T> {
    ...
    public int getMax(int numberThis, int numberThat) {
        return Math.max(numberThis, numberThat);
    }
